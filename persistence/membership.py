...
def join_public_group(user_id: str, role: str = "member") -> int:
    ...
    # Adds a user to the 'public' group and rotates the group key for all members (incl. the new one). then Returns new public version.
...
def leave_public_group(user_id: str) -> int:
    # Removes user from 'public' and rotates the group key for remaining members. then Returns new public version.
